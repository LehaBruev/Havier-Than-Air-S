...
namespace Havier_Than_Air_S
{
    public class AH_1 : Hely
    {
        ...
        protected override void SpawnHely()
        {
            ...
            //Настройки верталета
            maxpowery = 500000; //Максимальная сила влияет на вертолет
            maxpowerx = 30000; // 
            shagRUD = 25; // шаг увеличения мощности двигателя
            maxShagAngle = 1.3f; // шаг изменения угла атаки
            maxspeedhor = 200;
            maxspeedvert = 220;
            maxheigh = 500; // потолок полета
            speedxmax = new Vector2f(4.5f,3);
            Weight = 1500;
            ...
            engineMaxPower = 49250; // максимальное ускорение от двигателя //11250
            holdRPM = 18000; // Холостые обороты мотора
